...
class AptitudeVerbelQuiz : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_aptitude_verbel_quiz)
    ...
    private fun startTimer() {
        countDownTimer = object : CountDownTimer(totalTimeInMillis, 1000) {
            ...
            override fun onFinish() {
                Toast.makeText(this@AptitudeVerbelQuiz, "Time's up!", Toast.LENGTH_SHORT).show()
                finishQuiz()
            }
        }.start()
    }
    ...
    private fun finishQuiz(){
        ...
        // code for saving the data add the mark in new field in the current user
    }
}