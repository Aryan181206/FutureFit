...
│   │   └── AndroidManifest.xml
│   └── kotlin+java/
│       └── com.example.futurefit/
│           ├── AddSEC/
│           │   ├── AddExperience
│           │   └── AddSkillss
│           ├── Assessment/
│           │   ├── AptitudeLogicalQuiz
│           │   ├── AptitudeNumericalQuiz
│           │   ├── AptitudeVerbelQuiz
│           │   ├── InterestSurveyQuiz
│           │   └── PersonalityTraitQuiz
│           ├── AssessmentInstructions/
│           │   ├── AptitudeTestInstruction
│           │   ├── InterestTestInstruction
│           │   └── PersonalityTestInstruction
│           ├── AssessmentResult/
│           │   ├── AptitudeResult
│           │   ├── InterestResult
│           │   └── PersonalityResult
│           ├── AssessmentSplashScreen/
│           │   ├── AptitudeStartSplashScreen
│           │   ├── InterestSplashScreen
│           │   └── PersonalityStartSplashScreen
│           ├── Authentication/
│           │   ├── SignIn
│           │   └── SignUp
│           ├── DataClass/
...
│               └── ExampleUnitTest
├── assets/
│   ├── Aptitude_LogicalQuestions.json
│   ├── Aptitude_NumericalSkillsQuestions.json
│   ├── Aptitude_VerbalQuestions.json
│   ├── personalityTestQuestion.json
│   └── riasce_survey.json
├── res/
│   ├── anim/
│   │   └── shake.xml
